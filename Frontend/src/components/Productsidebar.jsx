...
const handleSortedData =(query)=>{
  axios.get(`https://my-json-server-masai.herokuapp.com/products?category=${query}`).then(({data})=>{
      console.log(data)
      dispatch(setproducts(data))
  })
}
const handleSorted =(order)=>{
  axios.get(`https://my-json-server-masai.herokuapp.com/products?_sort=price&_order=${order}`).then(({data})=>{
      console.log(data)
      dispatch(setproducts(data))
  })
}
